...
void main() {
  ...
  group('Check the default value of', () {
    final KakaoAuthButton kakaoAuthButton = KakaoAuthButton(onPressed: () {});
    test('text', () {
      expect(kakaoAuthButton.text, 'Sign in with Kakao');
    });
    test('isLoading', () {
      expect(kakaoAuthButton.isLoading, false);
    });
  });
