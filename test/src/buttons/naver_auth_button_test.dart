...
void main() {
  ...
  group('Check the default value of', () {
    final NaverAuthButton naverAuthButton = NaverAuthButton(onPressed: () {});
    test('text', () {
      expect(naverAuthButton.text, 'Sign in with Naver');
    });
    test('isLoading', () {
      expect(naverAuthButton.isLoading, false);
    });
  });
